...
ToolbarCollapse		: "KaЕќi Ilobreton",
...
Print				: "Presi",
SelectAll			: "Elekti Д‰ion",
RemoveFormat		: "Forigi Formaton",
InsertLinkLbl		: "Ligilo",
InsertLink			: "Enmeti/ЕњanДќi Ligilon",
RemoveLink			: "Forigi Ligilon",
VisitLink			: "Open Link",	//MISSING
Anchor				: "Enmeti/ЕњanДќi Ankron",
AnchorDelete		: "Remove Anchor",	//MISSING
InsertImageLbl		: "Bildo",
InsertImage			: "Enmeti/ЕњanДќi Bildon",
InsertFlashLbl		: "Flash",	//MISSING
InsertFlash			: "Insert/Edit Flash",	//MISSING
InsertTableLbl		: "Tabelo",
InsertTable			: "Enmeti/ЕњanДќi Tabelon",
...
BlockJustify		: "Дњisrandigi AmbaЕ­flanke",
DecreaseIndent		: "Malpligrandigi KrommarДќenon",
IncreaseIndent		: "Pligrandigi KrommarДќenon",
...
DeleteCells			: "Forigi Д€elojn",
MergeCells			: "Kunfandi Д€elojn",
MergeRight			: "Merge Right",	//MISSING
MergeDown			: "Merge Down",	//MISSING
HorizontalSplitCell	: "Split Cell Horizontally",	//MISSING
VerticalSplitCell	: "Split Cell Vertically",	//MISSING
TableDelete			: "Delete Table",	//MISSING
CellProperties		: "Atributoj de Д€elo",
...
HiddenFieldProp		: "Atributoj de KaЕќita Kampo",
...
Done				: "Finita",
PasteWordConfirm	: "La algluota teksto Еќajnas esti Word-devena. Д€u vi volas purigi Дќin antaЕ­ ol interglui?",
NotCompatiblePaste	: "Tiu Д‰i komando bezonas almenaЕ­ Internet Explorer 5.5. Д€u vi volas daЕ­rigi sen purigado?",
UnknownToolbarItem	: "Ilobretero nekonata \"%1\"",
UnknownCommand		: "Komandonomo nekonata \"%1\"",
NotImplemented		: "Komando ne ankoraЕ­ realigita",
...
DlgImgURL			: "URL",
DlgImgUpload		: "AlЕќuti",
DlgImgAlt			: "AnstataЕ­iga Teksto",
DlgImgWidth			: "LarДќo",
DlgImgHeight		: "Alto",
...
DlgLnkTypeURL		: "URL",
DlgLnkTypeAnchor	: "Ankri en tiu Д‰i paДќo",
DlgLnkTypeEMail		: "RetpoЕќto",
...
DlgLnkEMailBody		: "MesaДќa korpo",
DlgLnkUpload		: "AlЕќuti",
DlgLnkBtnUpload		: "Sendi al Servilo",

DlgLnkTarget		: "Celo",
DlgLnkTargetFrame	: "<kadro>",
DlgLnkTargetPopup	: "<Еќprucfenestro>",
...
DlgLnkPopWinName	: "Nomo de Ењprucfenestro",
DlgLnkPopWinFeat	: "Atributoj de la Ењprucfenestro",
DlgLnkPopResize		: "Grando ЕњanДќebla",
...
DlgTableAlign		: "Дњisrandigo",
DlgTableAlignNotSet	: "<DefaЕ­lte>",
DlgTableAlignLeft	: "Maldekstre",
DlgTableAlignCenter	: "Centre",
DlgTableAlignRight	: "Dekstre",
DlgTableWidth		: "LarДќo",
DlgTableWidthPx		: "Bitbilderoj",
DlgTableWidthPc		: "elcentoj",
DlgTableHeight		: "Alto",
DlgTableCellSpace	: "Interspacigo de Д€eloj",
DlgTableCellPad		: "Д€irkaЕ­enhava Plenigado",
...
DlgCellWordWrapNotSet	: "<DefaЕ­lte>",
DlgCellWordWrapYes	: "Jes",
DlgCellWordWrapNo	: "Ne",
DlgCellHorAlign		: "Horizonta Дњisrandigo",
DlgCellHorAlignNotSet	: "<DefaЕ­lte>",
DlgCellHorAlignLeft	: "Maldekstre",
DlgCellHorAlignCenter	: "Centre",
DlgCellHorAlignRight: "Dekstre",
DlgCellVerAlign		: "Vertikala Дњisrandigo",
DlgCellVerAlignNotSet	: "<DefaЕ­lte>",
...
// Find Dialog
DlgFindTitle		: "SerД‰i",
DlgFindFindBtn		: "SerД‰i",
DlgFindNotFoundMsg	: "La celteksto ne estas trovita.",

// Replace Dialog
DlgReplaceTitle			: "AnstataЕ­igi",
DlgReplaceFindLbl		: "SerД‰i:",
DlgReplaceReplaceLbl	: "AnstataЕ­igi per:",
DlgReplaceCaseChk		: "Kongruigi Usklecon",
DlgReplaceReplaceBtn	: "AnstataЕ­igi",
DlgReplaceReplAllBtn	: "AnstataЕ­igi Д€iun",
...
DlgSpellChangeTo		: "ЕњanДќi al",
DlgSpellBtnIgnore		: "Malatenti",
DlgSpellBtnIgnoreAll	: "Malatenti Д€iun",
DlgSpellBtnReplace		: "AnstataЕ­igi",
DlgSpellBtnReplaceAll	: "AnstataЕ­igi Д€iun",
DlgSpellBtnUndo			: "Malfari",
DlgSpellNoSuggestions	: "- Neniu propono -",
DlgSpellProgress		: "Literumkontrolado daЕ­ras...",
DlgSpellNoMispell		: "Literumkontrolado finita: neniu fuЕќo trovita",
DlgSpellNoChanges		: "Literumkontrolado finita: neniu vorto ЕќanДќita",
DlgSpellOneChange		: "Literumkontrolado finita: unu vorto ЕќanДќita",
DlgSpellManyChanges		: "Literumkontrolado finita: %1 vortoj ЕќanДќitaj",

IeSpellDownload			: "Literumada Kontrolilo ne instalita. Д€u vi volas elЕќuti Дќin nun?",
...
DlgDocGeneralTab	: "ДњeneralaДµoj",
DlgDocBackTab		: "Fono",
DlgDocColorsTab		: "Koloroj kaj MarДќenoj",
DlgDocMetaTab		: "Metadatumoj",

DlgDocPageTitle		: "PaДќotitolo",
...
DlgDocMargins		: "PaДќaj MarДќenoj",
DlgDocMaTop			: "Supra",
DlgDocMaLeft		: "Maldekstra",
DlgDocMaRight		: "Dekstra",
DlgDocMaBottom		: "Malsupra",
DlgDocMeIndex		: "Ењlosilvortoj de la Dokumento (apartigita de komoj)",
