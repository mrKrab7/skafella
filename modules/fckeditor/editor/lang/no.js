...
ToolbarCollapse		: "Skjul verktГёylinje",
ToolbarExpand		: "Vis verktГёylinje",

// Toolbar Items and Context Menu
Save				: "Lagre",
NewPage				: "Ny Side",
Preview				: "ForhГҐndsvis",
Cut					: "Klipp ut",
Copy				: "Kopier",
Paste				: "Lim inn",
...
RightJustify		: "HГёyrejuster",
BlockJustify		: "Blokkjuster",
DecreaseIndent		: "Senk nivГҐ",
IncreaseIndent		: "Гk nivГҐ",
...
TextField		: "Tekstboks",
Textarea		: "TekstomrГҐde",
HiddenField		: "Skjult felt",
Button			: "Knapp",
SelectionField	: "Rullegardinliste",
ImageButton		: "Bildeknapp",

FitWindow		: "Maksimer stГёrrelsen pГҐ redigeringsverktГёyet",
...
InsertRowBefore		: "Sett inn rad fГёr",
DeleteRows			: "Slett rader",
InsertColumnAfter	: "Sett inn kolonne etter",
InsertColumnBefore	: "Sett inn kolonne fГёr",
DeleteColumns		: "Slett kolonner",
InsertCellAfter		: "Sett inn celle etter",
InsertCellBefore	: "Sett inn celle fГёr",
DeleteCells			: "Slett celler",
MergeCells			: "SlГҐ sammen celler",
MergeRight			: "SlГҐ sammen hГёyre",
MergeDown			: "SlГҐ sammen ned",
...
TextareaProp		: "Egenskaper for tekstomrГҐde",
...
Done				: "Ferdig",
PasteWordConfirm	: "Teksten du prГёver ГҐ lime inn ser ut som om den kommer fra Word. Vil du rense den for unГёdvendig kode fГёr du limer inn?",
NotCompatiblePaste	: "Denne kommandoen er kun tilgjenglig for Internet Explorer versjon 5.5 eller bedre. Vil du fortsette uten ГҐ rense? (Du kan lime inn som ren tekst)",
UnknownToolbarItem	: "Ukjent menyvalg \"%1\"",
UnknownCommand		: "Ukjent kommando \"%1\"",
NotImplemented		: "Kommando ikke implimentert",
UnknownToolbarSet	: "VerktГёylinjesett \"%1\" finnes ikke",
NoActiveX			: "Din nettlesers sikkerhetsinstillinger kan begrense noen av funksjonene i redigeringsverktГёyet. Du mГҐ aktivere \"KjГёr ActiveX-kontroller og plugin-modeller\". Du kan oppleve feil og advarsler om manglende funksjoner",
BrowseServerBlocked : "Kunne ikke ГҐpne dialogboksen for filarkiv. Sjekk at popup-blokkering er deaktivert.",
DialogBlocked		: "Kunne ikke ГҐpne dialogboksen. Sjekk at popup-blokkering er deaktivert.",
VisitLinkBlocked	: "Kunne ikke ГҐpne et nytt vindu. Sjekk at popup-blokkering er deaktivert.",
...
DlgGenId			: "Id",
DlgGenLangDir		: "SprГҐkretning",
DlgGenLangDirLtr	: "Venstre til hГёyre (VTH)",
DlgGenLangDirRtl	: "HГёyre til venstre (HTV)",
DlgGenLangCode		: "SprГҐkkode",
...
DlgGenTitle			: "Tittel",
DlgGenContType		: "Type",
DlgGenLinkCharset	: "Lenket sprГҐkkart",
DlgGenStyle			: "Stil",
...
DlgImgWidth			: "Bredde",
DlgImgHeight		: "HГёyde",
DlgImgLockRatio		: "LГҐs forhold",
DlgBtnResetSize		: "Tilbakestill stГёrrelse",
DlgImgBorder		: "Ramme",
DlgImgHSpace		: "HMarg",
DlgImgVSpace		: "VMarg",
DlgImgAlign			: "Juster",
...
DlgImgAlignRight	: "HГёyre",
DlgImgAlignTextTop	: "Tekst topp",
DlgImgAlignTop		: "Topp",
DlgImgPreview		: "ForhГҐndsvis",
...
DlnLnkMsgInvPopName	: "Popup-vinduets navn mГҐ begynne med en bokstav, og kan ikke inneholde mellomrom",

// Color Dialog
DlgColorTitle		: "Velg farge",
DlgColorBtnClear	: "TГёm",
...
DlgFindAndReplaceTitle	: "SГёk og erstatt",

// Find Dialog
DlgFindTitle		: "SГёk",
DlgFindFindBtn		: "SГёk",
DlgFindNotFoundMsg	: "Fant ikke sГёketeksten.",

// Replace Dialog
DlgReplaceTitle			: "Erstatt",
DlgReplaceFindLbl		: "SГёk etter:",
DlgReplaceReplaceLbl	: "Erstatt med:",
DlgReplaceCaseChk		: "Skill mellom store og smГҐ bokstaver",
...
DlgPasteMsg2	: "Vennligst lim inn i den fГёlgende boksen med tastaturet (<STRONG>Ctrl+V</STRONG>) og trykk <STRONG>OK</STRONG>.",
DlgPasteSec		: "Din nettlesers sikkerhetsinstillinger gir ikke redigeringsverktГёyet direkte tilgang til utklippstavlen. Du mГҐ lime det igjen i dette vinduet.",
...
DlgSpellProgress		: "Stavekontroll pГҐgГҐr...",
DlgSpellNoMispell		: "Stavekontroll fullfГёrt: ingen feilstavinger funnet",
DlgSpellNoChanges		: "Stavekontroll fullfГёrt: ingen ord endret",
DlgSpellOneChange		: "Stavekontroll fullfГёrt: Ett ord endret",
DlgSpellManyChanges		: "Stavekontroll fullfГёrt: %1 ord endret",

IeSpellDownload			: "Stavekontroll er ikke installert. Vil du laste den ned nГҐ?",
...
DlgLstTypeLCase		: "SmГҐ bokstaver (a, b, c)",
DlgLstTypeUCase		: "Store bokstaver (A, B, C)",
DlgLstTypeSRoman	: "SmГҐ romerske tall (i, ii, iii)",
...
DlgDocLangDir		: "SprГҐkretning",
DlgDocLangDirLTR	: "Venstre til hГёyre (LTR)",
DlgDocLangDirRTL	: "HГёyre til venstre (RTL)",
DlgDocLangCode		: "SprГҐkkode",
...
DlgDocBgNoScroll	: "LГҐs bakgrunnsbilde",
DlgDocCText			: "Tekst",
DlgDocCLink			: "Link",
DlgDocCVisited		: "BesГёkt lenke",
DlgDocCActive		: "Aktiv lenke",
DlgDocMargins		: "Sidemargin",
DlgDocMaTop			: "Topp",
DlgDocMaLeft		: "Venstre",
DlgDocMaRight		: "HГёyre",
DlgDocMaBottom		: "Bunn",
DlgDocMeIndex		: "Dokument nГёkkelord (kommaseparert)",
DlgDocMeDescr		: "Dokumentbeskrivelse",
DlgDocMeAuthor		: "Forfatter",
DlgDocMeCopy		: "Kopirett",
DlgDocPreview		: "ForhГҐndsvising",

// Templates Dialog
Templates			: "Maler",
DlgTemplatesTitle	: "Innholdsmaler",
DlgTemplatesSelMsg	: "Velg malen du vil ГҐpne<br>(innholdet du har skrevet blir tapt!):",
