...
CellProperties		: "ProprietГ  cella",
TableProperties		: "ProprietГ  tabella",
ImageProperties		: "ProprietГ  immagine",
FlashProperties		: "ProprietГ  Oggetto Flash",

AnchorProp			: "ProprietГ  ancora",
ButtonProp			: "ProprietГ  bottone",
CheckboxProp		: "ProprietГ  checkbox",
HiddenFieldProp		: "ProprietГ  campo nascosto",
RadioButtonProp		: "ProprietГ  radio button",
ImageButtonProp		: "ProprietГ  bottone immagine",
TextFieldProp		: "ProprietГ  campo di testo",
SelectionFieldProp	: "ProprietГ  menu di selezione",
TextareaProp		: "ProprietГ  area di testo",
FormProp			: "ProprietГ  modulo",
...
NotCompatiblePaste	: "Questa funzione ГЁ disponibile solo per Internet Explorer 5.5 o superiore. Desideri incollare il testo senza pulirlo?",
...
NoActiveX			: "Le impostazioni di sicurezza del tuo browser potrebbero limitare alcune funzionalitГ  dell'editor. Devi abilitare l'opzione \"Esegui controlli e plug-in ActiveX\". Potresti avere errori e notare funzionalitГ  mancanti.",
BrowseServerBlocked : "Non ГЁ possibile aprire la finestra di espolorazione risorse. Verifica che tutti i blocca popup siano bloccati.",
DialogBlocked		: "Non ГЁ possibile aprire la finestra di dialogo. Verifica che tutti i blocca popup siano bloccati.",
...
// Image Dialog
DlgImgTitle			: "ProprietГ  immagine",
...
// Flash Dialog
DlgFlashTitle		: "ProprietГ  Oggetto Flash",
...
DlnLnkMsgInvPopName	: "Il nome del popup deve iniziare con una lettera, e non puГІ contenere spazi",
...
// Table Dialog
DlgTableTitle		: "ProprietГ  tabella",
DlgTableRows		: "Righe",
...
DlgFindNotFoundMsg	: "L'elemento cercato non ГЁ stato trovato.",
...
DlgPasteSec		: "A causa delle impostazioni di sicurezza del browser,l'editor non ГЁ in grado di accedere direttamente agli appunti. E' pertanto necessario incollarli di nuovo in questa finestra.",
...
// Document Properties
DocProps		: "ProprietГ  del Documento",

// Anchor Dialog
DlgAnchorTitle		: "ProprietГ  ancora",
...
BulletedListProp	: "ProprietГ  lista puntata",
NumberedListProp	: "ProprietГ  lista numerata",
DlgLstStart			: "Inizio",
DlgLstType			: "Tipo",
...
DlgTemplatesSelMsg	: "Seleziona il modello da aprire nell'editor<br />(il contenuto attuale verrГ  eliminato):",
