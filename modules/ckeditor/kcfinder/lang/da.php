...
$lang = array(
    ...
    "{count} files in the Clipboard are not readable. Do you want to copy the rest?" => "{count} filer i udklipsholderen ikke kan lР“В¦ses. Р“Вnsker du at kopiere resten?",
    "The files in the Clipboard are not movable." => "Filerne i udklipsholderen kan ikke flyttes.",
    "{count} files in the Clipboard are not movable. Do you want to move the rest?" => "{count} filer i udklipsholderen er ikke flytbare. Р“Вnsker du at flytte resten?",
    "The files in the Clipboard are not removable." => "Filerne i udklipsholderen kan ikke fjernes.",
    "{count} files in the Clipboard are not removable. Do you want to delete the rest?" => "{count} filer i udklipsholderen kan ikke fjernes. Р“Вnsker du at slette resten?",
    "The selected files are not removable." => "De valgte filer er ikke flytbare.",
    "{count} selected files are not removable. Do you want to delete the rest?" => "{count} valgte filer kan ikke fjernes. Р“Вnsker du at slette resten?",
